...
STATICFILES_DIRS = [ # Uncommented and added this for project-level static files
    BASE_DIR / "static",
]
...
SECURE_SSL_REDIRECT = config('SECURE_SSL_REDIRECT', default=False, cast=bool) # Modified default to False for safety
